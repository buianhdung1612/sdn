...
if (modalChangeFileName) {
    ...
    form.addEventListener("submit", (e) => {
        ...
        if (fileId) {
            ...
            fetch(`/file-manager/change-file-name/${fileId}`, {
                method: "PATCH",
                body: formData
            })
                .then(res => res.json())
    ...
    listButtonDeleteFile.forEach(button => {
        button.addEventListener("click", () => {
            ...
            drwaSwal("delete", `file: ${fileName}`, () => {
                fetch(`/file-manager/delete-file/${fileId}`, {
                    method: "DELETE"
                })
                    .then(res => res.json())
                    .then(data => {
...
if (formCreateFolder) {
    formCreateFolder.addEventListener("submit", (e) => {
        ...
        fetch(`/file-manager/folder/create`, {
            method: "POST",
            body: formData
        })
            .then(res => res.json())
...
if (breadcrumbFolder) {
    ...
    listFolder.forEach((item, index) => {
        ...
        htmls += `
            <li class="list-group-item bg-white">
                <a href="/file-manager?folderPath=${path}">
                    <i class="la la-angle-double-right text-info me-2"></i>
                    ${item}
                </a>
            </li>
    ...
    listButtonDeleteFolder.forEach(button => {
        button.addEventListener("click", () => {
            ...
            drwaSwal("destroy", `thư mục: ${folderName}`, () => {
                fetch(`/file-manager/folder/delete?folderPath=${folderFinal}`, {
                    method: "DELETE"
                })
                    .then(res => res.json())
                    .then(data => {
...
if (accountAdminChangePasswordForm) {
    ...
    validation
        ...
        .onSuccess((event) => {
            ...
            fetch(`/account-admin/change-password/${id}`, {
                method: "PATCH",
                body: formData
            })
                .then(res => res.json())
...
if (productEditCategoryForm) {
    ...
    validator
        ...
        .onSuccess((event) => {
            ...
            fetch(`/product/category/edit/${id}`, {
                method: "PATCH",
                body: formData
            })
                .then(res => res.json())
...
if (productCreateAttributeForm) {
    ...
    validation
        ...
        .onSuccess((event) => {
            ...
            fetch(`/product/attribute/create`, {
                method: "POST",
                body: formData
            })
                .then(res => res.json())
...
if (productEditAttributeForm) {
    ...
    validation
        ...
        .onSuccess((event) => {
            ...
            fetch(`/product/attribute/edit/${id}`, {
                method: "PATCH",
                body: formData
            })
                .then(res => res.json())
