...
export const createCategory = async (req: Request, res: Response) => {
    ...
    res.render('pages/product-create-category', {
...
export const editCategory = async (req: Request, res: Response) => {
    try {
        ...
        res.render('pages/product-edit-category', {
...
export const attribute = async (req: Request, res: Response) => {
    ...
    res.render("pages/product-attribute", {
...
export const createAttribute = async (req: Request, res: Response) => {
    res.render("pages/product-create-attribute", {
...
export const editAttribute = async (req: Request, res: Response) => {
    try {
        ...
        if (!attributeDetail) {
            res.redirect(`/product/attribute`);
            return;
        }

        res.render("pages/product-edit-attribute", {
