...
export const create = async (req: Request, res: Response) => {
    ...
    res.render("pages/account-admin-create", {
...
export const list = async (req: Request, res: Response) => {
    ...
    res.render("pages/account-admin-list", {
...
export const edit = async (req: Request, res: Response) => {
    try {
        ...
        if (!accountDetail) {
            res.redirect(`/account-admin/list`);
            return;
        }
        ...
        res.render("pages/account-admin-edit", {
...
export const changePassword = async (req: Request, res: Response) => {
    try {
        ...
        res.render("pages/account-admin-change-password", {
